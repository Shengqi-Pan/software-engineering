...
"background-color: rgb(129, 155, 198);")
        ...
        self.radioButton.setGeometry(QtCore.QRect(120, 530, 100, 32))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        self.radioButton.setFont(font)
        self.radioButton.setObjectName("radioButton")
        self.radioButton_2 = QtWidgets.QRadioButton(Login)
        self.radioButton_2.setGeometry(QtCore.QRect(260, 530, 100, 32))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
    ...
    def retranslateUi(self, Login):
        ...
        self.radioButton.setText(_translate("Login", "用 户"))
        self.radioButton_2.setText(_translate("Login", "管理员"))
